...
exports.seed = async function (knex) {
  await knex('satellites').del()
  await knex('satellites').insert([
    { name: "insight_1", longitude: 0, status: "GREEN", orbit: "GEO", mission: "COMMS", frequency_band: "UHF", country: "USA" , favorites: ["pMr2t4qkIgMwisegISjdwOMW9UU2"], image: "https://www.afcea.org/content/sites/default/files/field/image/RKA-USAF%20SATCOM-3-OCT17.jpg"},
    ...
    { name: "insight_5", longitude: 120, status: "YELLOW", orbit: "GEO", mission: "COMMS", frequency_band: "EHF", country: "USA" , favorites: ["pMr2t4qkIgMwisegISjdwOMW9UU2"], image: "https://www.afcea.org/content/sites/default/files/field/image/RKA-USAF%20SATCOM-3-OCT17.jpg"},
    ...
    { name: "insight_7", longitude: 180, status: "GREEN", orbit: "GEO", mission: "GPS", frequency_band: "EHF", country: "USA" , favorites: ["pMr2t4qkIgMwisegISjdwOMW9UU2"], image: "https://www.afcea.org/content/sites/default/files/field/image/RKA-USAF%20SATCOM-3-OCT17.jpg"},
    { name: "insight_8", longitude: -150, status: "YELLOW", orbit: "GEO", mission: "GPS", frequency_band: "SHF", country: "USA" , favorites: ["pMr2t4qkIgMwisegISjdwOMW9UU2"], image: "https://www.verdict.co.uk/wp-content/uploads/2020/01/satellite-breakthrough.jpg"},
    { name: "insight_9", longitude: -120, status: "RED", orbit: "GEO", mission: "GPS", frequency_band: "SHF", country: "USA" , favorites: ["pMr2t4qkIgMwisegISjdwOMW9UU2"], image: "https://www.afcea.org/content/sites/default/files/field/image/RKA-USAF%20SATCOM-3-OCT17.jpg"},
    ...
    { name: "insight_12", longitude: -30, status: "RED", orbit: "GEO", mission: "GPS", frequency_band: "SHF", country: "USA" , favorites: ["pMr2t4qkIgMwisegISjdwOMW9UU2"], image: "https://www.afcea.org/content/sites/default/files/field/image/RKA-USAF%20SATCOM-3-OCT17.jpg"}
  ]);
};
